...
- [ ] Frontend phase: signup, OTP verification, login, resend, forgot/reset screens, and reuse of
  the existing server-side handoff exchange to set the HttpOnly browser-session cookie.
